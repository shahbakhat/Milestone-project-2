...
| __Testing All inputs are working__| All inputs are working as they supposed to, all the input have correct output value as programmed, when number of people are less then 1 there is an error **required** *error* cant be less than zero. |    **PASS** |
